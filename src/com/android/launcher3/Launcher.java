...
//A:BWLWLLSS-18 gu.qian@ragentek.com 20161121 (start)
import android.telephony.SubscriptionManager;
import android.telephony.SubscriptionInfo;
//A:BWLWLLSS-18 gu.qian@ragentek.com 20161121 (end)
...
//add by luoran for low storage set wallpaper error(end)
/**
...
public class Launcher extends Activity
    ...
    private static final String IS_THE_FIRST_BOOT = "is_the_first_boot"; 
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		//A:BWLWLLSS-18 gu.qian@ragentek.com 20161121 (start)
        if("1".equals(android.os.SystemProperties.get("ro.rgk_stk_support"))){
    ...
    //add by luoran for N default_lock_wallpaper(start)
    private void setDefaultLockWallpaper(){
        try{
            ...
            NycWallpaperUtils.setStream(this,is,null,true,WallpaperManager.FLAG_LOCK);
           }catch(Exception e){         
        }
    }
    //add by luoran for N default_lock_wallpaper(end)
    ...
    protected void onResume() {
		...
		//A:DWEQBSE-140 gu.qian@ragentek.com 20161222 start 
        ...
        if (Settings.System.getInt(getContentResolver(), IS_THE_FIRST_BOOT, 1) == 1
            ...
            Settings.System.putString(getContentResolver(), "theme_switch_name", getResources().getString(R.string.rgktheme_default));
            Intent intent = new Intent(RGKGeneralConfig.THEME_ACTION);
            sendBroadcast(intent);
            Settings.System.putInt(getContentResolver(), IS_THE_FIRST_BOOT, 0);
        }
		//A:DWEQBSE-140 gu.qian@ragentek.com 20161222 end 
    ...
    protected void onClickWallpaperPicker(View v) {
        ...
        // modify by luoran for low storage set wallpaper error start
        if(!isStorageLow()){
		...
		// modify by luoran for low storage set wallpaper error end
    ...
    public void getSimName() {
    	mSimName = new String[2];
         ...
         if(subscriptionInfos != null){
        	...
        	if (mSimName != null) {
                   Log.i("RGKLauncher F","mSimName[0] = "+mSimName[0]+",mSimName[1] = "+mSimName[1]);//A:gu.qian@ragentek.com for test
        		mSimName[0] = getWangtedName(mSimName[0]);
        		mSimName[1] = getWangtedName(mSimName[1]);
                   Log.i("RGKLauncher S","mSimName[0] = "+mSimName[0]+",mSimName[1] = "+mSimName[1]);//A:gu.qian@ragentek.com for test
        	}
         }else{
            mSimName[0] = mSimName[1] = "SIM Toolkit";
         }
