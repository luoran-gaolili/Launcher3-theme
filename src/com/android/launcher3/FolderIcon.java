...
public class FolderIcon extends FrameLayout implements FolderListener {
    ...
    static FolderIcon fromXml(int resId, Launcher launcher, ViewGroup group,
        ...
        //add by zhaopenglin for rect folderiocn start
        if(is_rect_folder){
            icon.mPreviewBackground.setImageResource(R.drawable.portal_rect_inner);
        }else{
            icon.mPreviewBackground.setImageResource(R.drawable.portal_ring_inner);
        }
        //add by zhaopenglin for rect folderiocn end
    ...
    public static class FolderRingAnimator {
        ...
        public FolderRingAnimator(Launcher launcher, FolderIcon folderIcon) {
            ...
            if (sStaticValuesDirty) {
                ...
                //add by zhaopenglin for rect folderiocn start
                if(is_rect_folder){
                    sSharedOuterRingDrawable = res.getDrawable(R.drawable.portal_rect_inner);
                    sSharedInnerRingDrawable = res.getDrawable(R.drawable.portal_rect_inner);
                    sSharedFolderLeaveBehind = res.getDrawable(R.drawable.portal_rect_inner);
                }else{
                //add by zhaopenglin for rect folderiocn end
